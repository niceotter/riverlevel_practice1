...
Claude와 함께 한 비전공자 1인 개발입니다.

### 1) 프로젝트 동기

대학 시절 2019년부터 구상해 온 서비스였는데, 개발 능력의 한계로 구상 단계에서 중단했었습니다.

졸업하고 회사 재직 중에 다시 해보았지만 퇴근하고 밤에만 할 수 있어서 깔짝거리는 수준이라 진전이 없다시피 했습니다.
<br>그러다 AI의 발달을 목도하고 퇴사 후에 드디어 개발을 해보게 되었습니다.


퇴사하고 2달 정도 걸린 것 같습니다.
<br>도중에 여행 갔다온 거 감안하면 1달 조금 더 걸렸네요.
...
<br>현재 서울과 부산만 서비스 중입니다.
<br>한강홍수통제소 사이트에서 확인 가능한 모든 수위계를 이 사이트에도 올릴 수 있긴 한데 나머지를 언제 올릴지는 미정입니다.
...
현재 수위 보기를 클릭하면 수위계 명칭과, 데이터 집계 시각, 영점표고와 현재 수위, 주의 수위 정보가 표출됩니다.
...
혹시 저와 연락하고 싶으시다면 사이트의 &lt;버그 및 개선사항 제보&gt;를 이용해주세요.
