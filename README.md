...
졸업하고 회사 재직 중에 다시 해볼까 했는데 퇴근하고 밤에만 할 수 있었습니다.
<br>깔짝거리는 수준이라 진전이 없다시피 했는데, AI의 발달을 목도하고 퇴사 후에 드디어 개발을 해보게 되었습니다.

<br>퇴사하고 2달 정도 걸린 것 같습니다.
...
<br>(솔직히 하천 단면이나 해발수위는 좀 과잉 정보.. 지금 출입 통제되고 있는지만 보면 되는데)
...
<br>한강홍수통제소 사이트에서 확인 가능한 모든 수위계를 올릴 수 있긴 한데 나머지를 언제 올릴지는 미정입니다.
...
현재 수위 보기를 클릭하면 무슨 하천의 수위계인지, 언제 측정된 데이터인지, 영점표고와 현재 수위, 주의 수위 정보가 표출됩니다.
