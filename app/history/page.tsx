...
//  { point_code: '00-200-0012', point_name: '삼락22호교' },
  ...
  { point_code: '2022678', point_name: '대동낙동강교' },
  { point_code: '2022680', point_name: '구포대교' },
  { point_code: '2022682', point_name: '삼덕교' },
  { point_code: '2022688', point_name: '동서교' },
  ...
  { point_code: '2302650', point_name: '원동교' },
  { point_code: '2302651', point_name: '달음교' },
  { point_code: '2302655', point_name: '세병교' },
      ...
      <main style={{
        ...
        <div style={{
          ...
          <select value={siteId} onChange={e => setSiteId(e.target.value)} style={inputStyle}>
            ...
            {stations.map(s => (
              <option key={s.point_code} value={s.point_code}>{s.point_name}</option>
            ))}
          </select>
