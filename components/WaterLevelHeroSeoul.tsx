...
export default function WaterLevelHeroSeoul({ id, externalLink }: Props) {
  ...
  const ticks = [
    ...
    ...(calibratedWarn !== null
      ...
      : []),
    { key: 'current', label: `현재 수위 ${calibratedCurrent.toFixed(1)}m`, value: calibratedCurrent, color: '#1e00ff', right: 150, bottom: 20 },
    { key: 'floor', label: '바닥 0.0m', value: 0, color: '#000000', right: 26, bottom: -6 },
  ];
